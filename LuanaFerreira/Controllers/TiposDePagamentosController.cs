...
namespace LuanaFerreira.Controllers
{
    public class TiposDePagamentosController : Controller
    {
        ...
        {
            return View(await _context.TiposDePagamentos.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tipoDePagamento = await _context.TiposDePagamentos
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var tipoDePagamento = await _context.TiposDePagamentos.FindAsync(id);
            if (tipoDePagamento == null)
            {
                return NotFound();
            }
        ...
        {
            var tipoDePagamento = await _context.TiposDePagamentos.FindAsync(id);
            _context.TiposDePagamentos.Remove(tipoDePagamento);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.TiposDePagamentos.Any(e => e.Id == id);
        }
    }
}
