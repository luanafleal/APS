...
namespace LuanaFerreira.Controllers
{
    public class PagamentosComCartaoController : Controller
    {
        ...
        {
            return View(await _context.PagamentoComCartões.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pagamentoComCartao = await _context.PagamentoComCartões
        ...
        public async Task<IActionResult> Create([Bind("NomeDoCartao,Bandeira,Id,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var pagamentoComCartao = await _context.PagamentoComCartões.FindAsync(id);
            if (pagamentoComCartao == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NomeDoCartao,Bandeira,Id,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
        ...
        {
            var pagamentoComCartao = await _context.PagamentoComCartões.FindAsync(id);
            _context.PagamentoComCartões.Remove(pagamentoComCartao);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.PagamentoComCartões.Any(e => e.Id == id);
        }
    }
}
